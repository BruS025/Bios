...
<header>
    ...
    <div class="col-md-12" runat="server">
        ...
        <div class="col-md-2" runat="server">
            <asp:TextBox ID="idPlato" runat="server"  Height="34px" Enabled="true" Placeholder=" Plato" ></asp:TextBox>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img class="card-img-center" src="/Imagenes/logo.png" id="fotoMostrar" alt="Card image cap" runat="server" width="568" height="500" />
      </div>
      ...
      <div class="modal-body">      
          <div class="form-group" >
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <asp:DropDownList ID="ddlCasasPlato" runat="server" Height="34px" DataTextField="Nombre" DataValueField="RUT" ></asp:DropDownList>
                </div>
               </div>
      ...
      <div class="modal-body">      
          <div class="form-group" >
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <asp:DropDownList Enabled="false" ID="ddlCasaModificar" runat="server" Height="34px" DataTextField="Nombre" DataValueField="RUT" ></asp:DropDownList>
                </div>
               </div>
