    ...
    <h1 class="welcome text-center">Registrate en <br/> CometeloYA!</h1>
        ...
        <hr/>
            ...
            <form id="formulario" class="form-signin" runat="server">
                ...
                <p class="input_title">Nombre</p>
                <input type="text" id="inputUsername" runat="server" class="login_box" placeholder=" Ingrese nombre" required="required"/>

                <p class="input_title">Apellido</p>
                <input type="text" id="inputApellido" runat="server" class="login_box" placeholder=" Ingrese apellido" required="required"/>

                <p class="input_title">Nombre de usuario</p>
                <input type="text" id="inputEmail" runat="server" class="login_box" placeholder=" Ingrese nombre de login de usuario" required="required"/>
                ...
                <div>
                    ...
                    <p runat="server" id="dirTitle" class="input_title">Calle</p>
                    <input type="text" id="inputCalle" runat="server" class="login_box" placeholder=" Ingrese calle" required="required"/>

                    <p runat="server" id="P2" class="input_title">Puerta</p>
                    <input type="text" id="inputPuerta" runat="server" class="login_box" placeholder=" Ingrese puerta" required="required"/>
                </div>
