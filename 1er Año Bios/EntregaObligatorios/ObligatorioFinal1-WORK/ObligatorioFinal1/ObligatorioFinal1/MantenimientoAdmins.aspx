    ...
    <div class="col-md-12" id="divAdmin" runat="server" height="34px">
        ...
        <div class="col-md-12" runat="server">
            <div class="col-md-2" runat="server">
                <button type="button" class="btn-md btn-primary" data-toggle="modal" data-target="#agregarModal" data-whatever="Agregar una casa" id="btAgregar"><span aria-hidden="true" class="glyphicon glyphicon-plus"></span> Agregar</button>
            </div>
        ...
        <h4 class="modal-title" runat="server"><asp:Label ID="Label2" runat="server" Text="Agregar administrador:"></asp:Label></h4>
           ...
           <div class="col-md-12">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <asp:DropDownList ID="ddlCargo" runat="server" Height="34px" DataTextField="Tipo" DataValueField="Id" ></asp:DropDownList>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="agregarContrasenia" runat="server" Height="34px" Placeholder="Password" TextMode="Password"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="col-md-4">                  
                    <label for="message-text" class="control-label">Confirmar contraseña:</label>
            </div>
                <div class="col-md-4">
                    <asp:TextBox ID="agregarContraseniaConfirm" runat="server" Height="34px" Placeholder="Password" TextMode="Password"></asp:TextBox>
                </div>
            </div>
          ...
          <div class="form-group" >
           ...
           <div class="col-md-12">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-2">
                    <asp:DropDownList ID="editarDdl" runat="server" Height="34px" DataTextField="Tipo" DataValueField="Id" ></asp:DropDownList>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="modContrasenia" runat="server" Height="34px" Placeholder="Password"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="modContraseniaConfirm" runat="server" Height="34px" Placeholder="Password"></asp:TextBox>
                </div>
            </div>
