...
namespace Persistencia
{
    public class PersistenciaPlato
    {
        ...
        public static Plato Buscar(int id, long rut)
        {
            ...
            SqlConnection conexion = new SqlConnection(Conexion.CnnString);
            SqlCommand comando = new SqlCommand("SP_BuscarPlato", conexion);
            comando.CommandType = CommandType.StoredProcedure;
            // parametros del sp
            SqlParameter parametroId = new SqlParameter("@IdPlatoCasa", id);
            SqlParameter parametroRut = new SqlParameter("@Rut", rut);
        ...
        public static int Modificar(Plato plato, long rut)
        {
            ...
            SqlParameter parametroId = new SqlParameter("@IdOriginal", plato.Id);
