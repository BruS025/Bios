<%@ Page Language="C#" AutoEventWireup="true" CodeFile="06-ControlSqlDataSource.aspx.cs" Inherits="_06_ControlSqlDataSource" %>
...
<body>
    ...
    <br />
        <asp:SqlDataSource ID="sdsArticulos" runat="server" ConnectionString="Data Source=.; Initial Catalog = Ventas; Integrated Security = True" DeleteCommand="DELETE FROM Articulos WHERE codArt =@Codigo" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM articulos">
            <DeleteParameters>
