...
using System.Data;
    ...
    public static class Persistencia
    {
        ...
        public static Articulo BuscarArt(int Codigo)
    {
        Articulo art = null;

        SqlConnection oConexion = new SqlConnection(_cnn);
        SqlCommand oComando = new SqlCommand("BuscoArticulo " + Codigo, oConexion);
        SqlDataReader _Reader;
        ...
        try
        {
            ...
            if (_Reader.Read())
            {
                art = new Articulo((int)_Reader["CodArt"], (string)_Reader["NomArt"], (decimal)_Reader["PreArt"], BuscarFam((int)_Reader["CodFam"]));
            }
            _Reader.Close();
            return art;
        }
