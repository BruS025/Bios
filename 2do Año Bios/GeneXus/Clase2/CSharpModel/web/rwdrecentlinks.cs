/*
       ...
       Generated on: 9/14/2017 20:10:29.38
...
namespace GeneXus.Programs {
   public class rwdrecentlinks : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201791420102941", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm052( )
      {
         ...
         {
            context.AddJavascriptSource("rwdrecentlinks.js", "?201791420102942", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201791420102955", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("rwdrecentlinks.js", "?201791420102956", false);
      ...
      protected void sendrow_82( )
      {
         ...
         if ( LinksContainer.GetWrapped() == 1 )
         {
            ...
            {
               context.WriteHtmlText( "<tr"+" class=\""+"RecentLinksGrid"+"\" style=\""+""+"\""+" data-gxrow=\""+sGXsfl_8_idx+"\">") ;
            }
            if ( 1 > 0 )
            {
