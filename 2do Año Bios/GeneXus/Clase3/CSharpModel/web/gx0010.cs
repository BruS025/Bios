/*
       ...
       Generated on: 9/21/2017 19:41:20.3
...
namespace GeneXus.Programs {
   public class gx0010 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cProductoId, AV7cProductoNombre, AV8cProductoPrecio) ;
            ...
            {
               AV9pProductoId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pProductoId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9pProductoId), 4, 0)));
            }
            if ( context.isSpaRequest( ) )
            {
               enableJsOutput();
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20179211941205", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0010.aspx") + "?" + UrlEncode("" +AV9pProductoId)+"\">") ;
      ...
      {
         return formatLink("gx0010.aspx") + "?" + UrlEncode("" +AV9pProductoId) ;
      }
      ...
      protected void WB070( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCproductoid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cProductoId), 4, 0, ".", "")), ((edtavCproductoid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6cProductoId), "ZZZ9")) : context.localUtil.Format( (decimal)(AV6cProductoId), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCproductoid_Jsonclick, 0, "Attribute", "", "", "", edtavCproductoid_Visible, edtavCproductoid_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCproductoprecio_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cProductoPrecio), 4, 0, ".", "")), ((edtavCproductoprecio_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8cProductoPrecio), "ZZZ9")) : context.localUtil.Format( (decimal)(AV8cProductoPrecio), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCproductoprecio_Jsonclick, 0, "Attribute", "", "", "", edtavCproductoprecio_Visible, edtavCproductoprecio_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_PRODUCTONOMBRE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A2ProductoNombre, "")), context));
         GxWebStd.gx_hidden_field( context, "PRODUCTONOMBRE", StringUtil.RTrim( A2ProductoNombre));
         GxWebStd.gx_hidden_field( context, "gxhash_PRODUCTOPRECIO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A3ProductoPrecio), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "PRODUCTOPRECIO", StringUtil.LTrim( StringUtil.NToC( (decimal)(A3ProductoPrecio), 4, 0, ".", "")));
      }
      ...
      protected void RF072( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00072 */
            pr_default.execute(0, new Object[] {AV6cProductoId, lV7cProductoNombre, AV8cProductoPrecio, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_44_idx = 1;
            sGXsfl_44_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_44_idx), 4, 0)), 4, "0");
            SubsflControlProps_442( ) ;
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cProductoNombre", AV7cProductoNombre);
         /* Using cursor H00073 */
         pr_default.execute(1, new Object[] {AV6cProductoId, lV7cProductoNombre, AV8cProductoPrecio});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201792119412054", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0010.js", "?201792119412054", false);
      ...
      protected void SubsflControlProps_442( )
      {
         ...
         edtProductoPrecio_Internalname = "PRODUCTOPRECIO_"+sGXsfl_44_idx;
      }
      ...
      protected void SubsflControlProps_fel_442( )
      {
         ...
         edtProductoPrecio_Internalname = "PRODUCTOPRECIO_"+sGXsfl_44_fel_idx;
      }
      ...
      protected void sendrow_442( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_44_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtProductoNombre_Internalname, "Link", edtProductoNombre_Link, !bGXsfl_44_Refreshing);
            ...
            GxWebStd.gx_hidden_field( context, "gxhash_PRODUCTOID"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, context.localUtil.Format( (decimal)(A1ProductoId), "ZZZ9"), context));
            GxWebStd.gx_hidden_field( context, "gxhash_PRODUCTONOMBRE"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, StringUtil.RTrim( context.localUtil.Format( A2ProductoNombre, "")), context));
            GxWebStd.gx_hidden_field( context, "gxhash_PRODUCTOPRECIO"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, context.localUtil.Format( (decimal)(A3ProductoPrecio), "ZZZ9"), context));
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'subGrid1_Rows',nv:0},{av:'AV6cProductoId',fld:'vCPRODUCTOID',pic:'ZZZ9',nv:0},{av:'AV7cProductoNombre',fld:'vCPRODUCTONOMBRE',pic:'',nv:''},{av:'AV8cProductoPrecio',fld:'vCPRODUCTOPRECIO',pic:'ZZZ9',nv:0}],oparms:[]}");
         ...
         setEventMetadata("LBLPRODUCTOIDFILTER.CLICK","{handler:'E11071',iparms:[{av:'divProductoidfiltercontainer_Class',ctrl:'PRODUCTOIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divProductoidfiltercontainer_Class',ctrl:'PRODUCTOIDFILTERCONTAINER',prop:'Class'},{av:'edtavCproductoid_Visible',ctrl:'vCPRODUCTOID',prop:'Visible'}]}");
         setEventMetadata("LBLPRODUCTONOMBREFILTER.CLICK","{handler:'E12071',iparms:[{av:'divProductonombrefiltercontainer_Class',ctrl:'PRODUCTONOMBREFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divProductonombrefiltercontainer_Class',ctrl:'PRODUCTONOMBREFILTERCONTAINER',prop:'Class'},{av:'edtavCproductonombre_Visible',ctrl:'vCPRODUCTONOMBRE',prop:'Visible'}]}");
         setEventMetadata("LBLPRODUCTOPRECIOFILTER.CLICK","{handler:'E13071',iparms:[{av:'divProductopreciofiltercontainer_Class',ctrl:'PRODUCTOPRECIOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divProductopreciofiltercontainer_Class',ctrl:'PRODUCTOPRECIOFILTERCONTAINER',prop:'Class'},{av:'edtavCproductoprecio_Visible',ctrl:'vCPRODUCTOPRECIO',prop:'Visible'}]}");
         setEventMetadata("ENTER","{handler:'E17072',iparms:[{av:'A1ProductoId',fld:'PRODUCTOID',pic:'ZZZ9',hsh:true,nv:0}],oparms:[{av:'AV9pProductoId',fld:'vPPRODUCTOID',pic:'ZZZ9',nv:0}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'subGrid1_Rows',nv:0},{av:'AV6cProductoId',fld:'vCPRODUCTOID',pic:'ZZZ9',nv:0},{av:'AV7cProductoNombre',fld:'vCPRODUCTONOMBRE',pic:'',nv:''},{av:'AV8cProductoPrecio',fld:'vCPRODUCTOPRECIO',pic:'ZZZ9',nv:0}],oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'subGrid1_Rows',nv:0},{av:'AV6cProductoId',fld:'vCPRODUCTOID',pic:'ZZZ9',nv:0},{av:'AV7cProductoNombre',fld:'vCPRODUCTONOMBRE',pic:'',nv:''},{av:'AV8cProductoPrecio',fld:'vCPRODUCTOPRECIO',pic:'ZZZ9',nv:0}],oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'subGrid1_Rows',nv:0},{av:'AV6cProductoId',fld:'vCPRODUCTOID',pic:'ZZZ9',nv:0},{av:'AV7cProductoNombre',fld:'vCPRODUCTONOMBRE',pic:'',nv:''},{av:'AV8cProductoPrecio',fld:'vCPRODUCTOPRECIO',pic:'ZZZ9',nv:0}],oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'subGrid1_Rows',nv:0},{av:'AV6cProductoId',fld:'vCPRODUCTOID',pic:'ZZZ9',nv:0},{av:'AV7cProductoNombre',fld:'vCPRODUCTONOMBRE',pic:'',nv:''},{av:'AV8cProductoPrecio',fld:'vCPRODUCTOPRECIO',pic:'ZZZ9',nv:0}],oparms:[]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0010__default(),
            new Object[][] {
                new Object[] {
               H00072_A3ProductoPrecio, H00072_A2ProductoNombre, H00072_A1ProductoId
               }
               , new Object[] {
   ...
   public class gx0010__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6cProductoId )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [ProductoPrecio], [ProductoNombre], [ProductoId]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00072(context, (String)dynConstraints[0] , (short)dynConstraints[1] , (String)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
               case 1 :
                     return conditional_H00073(context, (String)dynConstraints[0] , (short)dynConstraints[1] , (String)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
         }
