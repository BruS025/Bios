/*
       ...
       Generated on: 9/21/2017 19:41:14.76
   ...
   public class producto : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void Draw( )
      {
         ...
         if ( ! GxWebStd.gx_redirect( context) )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtProductoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1ProductoId), 4, 0, ".", "")), ((edtProductoId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A1ProductoId), "ZZZ9")) : context.localUtil.Format( (decimal)(A1ProductoId), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,33);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductoId_Jsonclick, 0, "Attribute", "", "", "", 1, edtProductoId_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Producto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtProductoNombre_Internalname, StringUtil.RTrim( A2ProductoNombre), StringUtil.RTrim( context.localUtil.Format( A2ProductoNombre, "")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,37);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductoNombre_Jsonclick, 0, "Attribute", "", "", "", 1, edtProductoNombre_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Producto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtProductoPrecio_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A3ProductoPrecio), 4, 0, ".", "")), ((edtProductoPrecio_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A3ProductoPrecio), "ZZZ9")) : context.localUtil.Format( (decimal)(A3ProductoPrecio), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,41);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductoPrecio_Jsonclick, 0, "Attribute", "", "", "", 1, edtProductoPrecio_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Producto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void Load011( )
      {
         ...
         {
            RcdFound1 = 1;
            A2ProductoNombre = T00014_A2ProductoNombre[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A2ProductoNombre", A2ProductoNombre);
            A3ProductoPrecio = T00014_A3ProductoPrecio[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A3ProductoPrecio", StringUtil.LTrim( StringUtil.Str( (decimal)(A3ProductoPrecio), 4, 0)));
            ZM011( -3) ;
         }
         pr_default.close(2);
      ...
      protected void CheckExtendedTable011( )
      {
         Gx_BScreen = 1;
         standaloneModal( ) ;
         if ( String.IsNullOrEmpty(StringUtil.RTrim( A2ProductoNombre)) )
         {
            GX_msglist.addItem("El Nombre no puede estar vacio", 1, "PRODUCTONOMBRE");
            AnyError = 1;
            GX_FocusControl = edtProductoNombre_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         if ( (0==A3ProductoPrecio) )
         {
            GX_msglist.addItem("El Precio no puede estar vacio", 1, "PRODUCTOPRECIO");
            AnyError = 1;
            GX_FocusControl = edtProductoPrecio_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      protected void move_next( )
      {
         RcdFound1 = 0;
         /* Using cursor T00016 */
         pr_default.execute(4, new Object[] {A1ProductoId});
         if ( (pr_default.getStatus(4) != 101) )
         {
            while ( (pr_default.getStatus(4) != 101) && ( ( T00016_A1ProductoId[0] < A1ProductoId ) ) )
            {
               pr_default.readNext(4);
            }
            if ( (pr_default.getStatus(4) != 101) && ( ( T00016_A1ProductoId[0] > A1ProductoId ) ) )
            {
               A1ProductoId = T00016_A1ProductoId[0];
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A1ProductoId", StringUtil.LTrim( StringUtil.Str( (decimal)(A1ProductoId), 4, 0)));
               RcdFound1 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         {
            while ( (pr_default.getStatus(5) != 101) && ( ( T00017_A1ProductoId[0] > A1ProductoId ) ) )
            {
               pr_default.readNext(5);
            }
            if ( (pr_default.getStatus(5) != 101) && ( ( T00017_A1ProductoId[0] < A1ProductoId ) ) )
            {
               A1ProductoId = T00017_A1ProductoId[0];
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A1ProductoId", StringUtil.LTrim( StringUtil.Str( (decimal)(A1ProductoId), 4, 0)));
               RcdFound1 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency011( )
      {
         if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z2ProductoNombre, T00012_A2ProductoNombre[0]) != 0 ) || ( Z3ProductoPrecio != T00012_A3ProductoPrecio[0] ) )
            {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00018 */
                     pr_default.execute(6, new Object[] {A2ProductoNombre, A3ProductoPrecio});
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00019 */
                     pr_default.execute(7, new Object[] {A2ProductoNombre, A3ProductoPrecio, A1ProductoId});
                     pr_default.close(7);
                     dsDefault.SmartCacheProvider.SetUpdated("Producto") ;
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(8, new Object[] {A1ProductoId});
                  pr_default.close(8);
                  dsDefault.SmartCacheProvider.SetUpdated("Producto") ;
                  if ( AnyError == 0 )
                  {
      ...
      protected void OnDeleteControls011( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(9, new Object[] {A1ProductoId});
            if ( (pr_default.getStatus(9) != 101) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_del", new   object[]  {"Factura Producto"}), "CannotDeleteReferencedRecord", 1, "");
               AnyError = 1;
            }
            pr_default.close(9);
         }
      ...
      public void ScanStart011( )
      {
         ...
         {
            RcdFound1 = 1;
            A1ProductoId = T000112_A1ProductoId[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A1ProductoId", StringUtil.LTrim( StringUtil.Str( (decimal)(A1ProductoId), 4, 0)));
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201792119411545", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("producto.aspx") +"\">") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201792119411549", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("producto.js", "?201792119411549", false);
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         T00014_A1ProductoId = new short[1] ;
         T00014_A2ProductoNombre = new String[] {""} ;
         T00014_A3ProductoPrecio = new short[1] ;
         ...
         sMode1 = "";
         T00016_A1ProductoId = new short[1] ;
         ...
         T000111_A4FacturaId = new short[1] ;
         T000111_A1ProductoId = new short[1] ;
         T000112_A1ProductoId = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.producto__default(),
            new Object[][] {
                new Object[] {
               T00012_A1ProductoId, T00012_A2ProductoNombre, T00012_A3ProductoPrecio
               }
               , new Object[] {
               T00013_A1ProductoId, T00013_A2ProductoNombre, T00013_A3ProductoPrecio
               }
               , new Object[] {
               T00014_A1ProductoId, T00014_A2ProductoNombre, T00014_A3ProductoPrecio
               }
               , new Object[] {
               T00015_A1ProductoId
               }
               ...
               , new Object[] {
               T000111_A4FacturaId, T000111_A1ProductoId
               }
               , new Object[] {
               T000112_A1ProductoId
               }
            }
         );
      }
      ...
      private short[] T00014_A1ProductoId ;
      private String[] T00014_A2ProductoNombre ;
      private short[] T00014_A3ProductoPrecio ;
      ...
      private short[] T00016_A1ProductoId ;
      ...
      private short[] T000111_A4FacturaId ;
      private short[] T000111_A1ProductoId ;
      private short[] T000112_A1ProductoId ;
   ...
   public class producto__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("T00012", "SELECT [ProductoId], [ProductoNombre], [ProductoPrecio] FROM [Producto] WITH (UPDLOCK) WHERE [ProductoId] = @ProductoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00012,1,0,true,false )
             ,new CursorDef("T00013", "SELECT [ProductoId], [ProductoNombre], [ProductoPrecio] FROM [Producto] WITH (NOLOCK) WHERE [ProductoId] = @ProductoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00013,1,0,true,false )
             ,new CursorDef("T00014", "SELECT TM1.[ProductoId], TM1.[ProductoNombre], TM1.[ProductoPrecio] FROM [Producto] TM1 WITH (NOLOCK) WHERE TM1.[ProductoId] = @ProductoId ORDER BY TM1.[ProductoId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT00014,100,0,true,false )
             ,new CursorDef("T00015", "SELECT [ProductoId] FROM [Producto] WITH (NOLOCK) WHERE [ProductoId] = @ProductoId  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT00015,1,0,true,false )
             ,new CursorDef("T00016", "SELECT TOP 1 [ProductoId] FROM [Producto] WITH (NOLOCK) WHERE ( [ProductoId] > @ProductoId) ORDER BY [ProductoId]  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT00016,1,0,true,true )
             ,new CursorDef("T00017", "SELECT TOP 1 [ProductoId] FROM [Producto] WITH (NOLOCK) WHERE ( [ProductoId] < @ProductoId) ORDER BY [ProductoId] DESC  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT00017,1,0,true,true )
             ,new CursorDef("T00018", "INSERT INTO [Producto]([ProductoNombre], [ProductoPrecio]) VALUES(@ProductoNombre, @ProductoPrecio); SELECT SCOPE_IDENTITY()", GxErrorMask.GX_NOMASK,prmT00018)
             ,new CursorDef("T00019", "UPDATE [Producto] SET [ProductoNombre]=@ProductoNombre, [ProductoPrecio]=@ProductoPrecio  WHERE [ProductoId] = @ProductoId", GxErrorMask.GX_NOMASK,prmT00019)
             ,new CursorDef("T000110", "DELETE FROM [Producto]  WHERE [ProductoId] = @ProductoId", GxErrorMask.GX_NOMASK,prmT000110)
             ,new CursorDef("T000111", "SELECT TOP 1 [FacturaId], [ProductoId] FROM [FacturaFacturaProducto] WITH (NOLOCK) WHERE [ProductoId] = @ProductoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000111,1,0,true,true )
             ,new CursorDef("T000112", "SELECT [ProductoId] FROM [Producto] WITH (NOLOCK) ORDER BY [ProductoId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000112,100,0,true,false )
          };
       }
    }
