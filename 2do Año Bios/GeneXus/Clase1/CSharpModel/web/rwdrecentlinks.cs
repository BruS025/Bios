/*
       ...
       Generated on: 9/7/2017 19:54:33.18
...
namespace GeneXus.Programs {
   public class rwdrecentlinks : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20179719543328");
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, "FORM", "Class", "form-horizontal Form");
         }
         else
         {
      ...
      protected void RenderHtmlCloseForm052( )
      {
         ...
         {
            context.AddJavascriptSource("rwdrecentlinks.js", "?20179719543329");
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20179719543348");
            idxLst = (int)(idxLst+1);
         }
      ...
      {
         context.AddJavascriptSource("rwdrecentlinks.js", "?20179719543348");
      ...
      public override void initialize( )
      {
         ...
         AV11RecentLinksItems = new GXBaseCollection<SdtLinkList_LinkItem>( context, "LinkList.LinkItem", "GeneXus");
