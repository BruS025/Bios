/*
       ...
       Generated on: 9/7/2017 19:54:33.68
...
namespace GeneXus.Programs {
   public class appmasterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm012( )
      {
         ...
         context.AddJavascriptSource("appmasterpage.js", "?20179719543368");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?20179719543378");
            idxLst = (int)(idxLst+1);
         }
      ...
      {
         context.AddJavascriptSource("appmasterpage.js", "?20179719543378");
